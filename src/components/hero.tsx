...
const socials: {
...
}[] = [
  {
    name: "GitHub",
    icon: GitHub,
    link: "https://github.com/Nithin1729S",
  },
  {
    name: "LinkedIn",
    icon: LinkedIn,
    link: "https://www.linkedin.com/in/nithin1729s/",
  },
  {
    name: "Mail",
    icon: Mail,
    link: "mailto:sureshnithin1729@gmail.com",
  },
  {
    name: "Leetcode",
    icon: Leetcode,
    ...
    <header className="flex flex-shrink-0 flex-col justify-between pb-0 pt-10 md:pt-16 lg:sticky lg:top-0 lg:max-h-screen lg:pb-16">
      <section>
        ...
        <div className="mt-10 text-skeptic-800">
          ...
          <h2 className="mt-1 text-xl tracking-tight">SWE Intern @ Google India &apos;25</h2>
        </div>
        <nav
